@extends('layouts.app')
@section('title', 'Contract Toddlers | High5 Daycare')
@section('content')
            ...
            <div class="d-flex flex-stack flex-row-fluid">
                ...
                <div class="d-flex flex-column flex-row-fluid">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold mb-3 fs-7">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-gray-700">Contract Toddler</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="col-md-12 mb-xl-10">
                    ...
                    <div class="card card-flush">
                        ...
                        <div class="card-body align-items-end">
                            <!--begin::Wrapper-->
                            <form class="form" method="POST" action="{{route('add.kid.contract',['kid' => $kid->id])}}" id="kt_modal_add_event_form">
                                @csrf

                                <input type="hidden" name="contract_type" value="toddler">
                                <!--begin::Modal header-->
                                <!--begin::Modal title-->
                                            ...
                                            <p>We provide healthy and nutritious meals. We would provide a breakfast,
                                                ...
                                                <div class="row row-cols-2">
                                                    ...
                                                    <div class="d-flex flex-column fv-row">
                                                        ...
                                                        name="parent_name" placeholder="" value="{{ old('parent_name', optional($kid->contract)->parent_name) ?: Auth::user()->parent->name }}">
                                                        @error('parent_name')
                                                        <div style="color: red;">
                                                        {{ $message }}
                                                        </div>
