@extends('layouts.app')
@section('title', 'Subsidary From Ministry | High5 Daycare')
@section('content')
<style>
    .heading th{
                ...
                <div class="d-flex flex-column flex-row-fluid">
                    ...
                    <div class="page-title d-flex align-items-center me-3">
                        ...
                        <h1 class="page-heading d-flex flex-column justify-content-center text-white fw-bold fs-lg-3x gap-2">
                            <span>Subsidary From Ministry</span>
                        </h1>
                        <!--end::Title-->
                    </div>
                    <!--end::Page title-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold mb-3 fs-7">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-white">Subsidary From Ministry</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Ministry Subsidary Ledger for {{ $currentMonth }}</h3>
                        ...
                        <table class="table table-bordered table-striped">
                            <thead>
                                <tr class="bg-primary text-white heading">
                                    ...
                                    <th>Ministry Code</th>
                                    <th>Reg No.</th>
                                    <th>Eligibility Date From</th>
                                    <th>Eligibility Date To</th>
                                    <th>Kid Name</th>
                                    <th>Parent Name</th>
                                    <th>Provider Name</th>
                                    <th>DOB</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ optional($entry->kid)->subsidized_from ? $entry->kid->subsidized_from->format('F,j,Y') : '' }}</td>
                                    <td>{{ optional($entry->kid)->subsidized_from ? $entry->kid->subsidized_to->format('F,j,Y') : '' }}</td>
