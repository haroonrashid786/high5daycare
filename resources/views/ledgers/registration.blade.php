                ...
                <div class="d-flex flex-column flex-row-fluid">
                    ...
                    <div class="page-title d-flex align-items-center me-3">
                        ...
                        <h1 class="page-heading d-flex flex-column justify-content-center text-white fw-bold fs-lg-3x gap-2">
                            <span>Registration Fee Ledger</span>
                        </h1>
                        <!--end::Title-->
                    </div>
                    <!--end::Page title-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold mb-3 fs-7">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-white">Registration Fee Ledger</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Registration Fee Ledger</h3>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->registeration_fee }}</td>
                                    <td></td>
                                    <td>{{ $income += $item->registeration_fee}}</td>
                                </tr>
                                @endforeach
                                @else
