            ...
            <div class="d-flex flex-stack flex-row-fluid">
                ...
                <div class="d-flex flex-column flex-row-fluid">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold mb-3 fs-7">
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-[#557B43] fw-bold lh-1">
                        ...
                        <li class="breadcrumb-item">
                            <i class="ki-outline ki-right fs-7 text-[#557B43] mx-n1"></i>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Ministry Ledger GOG @if($currentMonth != 'all') for {{ $currentMonth->format('F,Y') }} @endif</h3>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                @php
                                $balance -= ($entry->total_no_of_days ? $entry->total_no_of_days : 0) * ($entry->provider ? $entry->provider->ministry_funding : 0);
                                $rate = $entry->gog_fund ? $entry->gog_fund / $entry->provider_presence : 0;
                                @endphp
                                <tr>
                                    ...
                                    <td>{{ $rate }}</td>
                                    <td></td>
                                    <td>{{ (($entry->total_no_of_days ? $entry->total_no_of_days : 0) *  ($entry->provider ? $entry->provider->ministry_funding : 0)) }}</td>
                                    <td>{{ $balance }}</td>
                                </tr>
                                @endforeach
                                @else
