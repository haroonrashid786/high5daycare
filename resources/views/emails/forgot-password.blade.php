...
<body>
    <div class="container">
        ...
        <p style="font-family: 'Arial', sans-serif;">It appears that a password reset request has been initiated for your account.</p>
        ...
        <p style="font-family: 'Arial', sans-serif;">Please use the provided temporary password to access your account. Once logged in, we recommend updating your password to something memorable through the account settings for added security:</p>
