...
<body>
    <div class="container">
        ...
        <p style="font-family: 'Arial', sans-serif;"><b>Dear {{ucfirst($parent)}},</b></p>
        <p style="font-family: 'Arial', sans-serif;">Alert! New accident report just have been added to your portal.</p>
        <div class="table-container">
            <table class="table">
                ...
                <tr>
                    <td>Location & Observer</td>
                    <td>{{ $location }}  |  {{ $observer }}</td>
                </tr>
            </table>
        </div>
        <p style="font-family: 'Arial', sans-serif;">To check complete details, please login to you portal and complete that form:</p>
        <p><a class="button" href="{{ route('incidents') }}" target="_blank">Login to your Portal</a></p>
