...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1 style="font-family: 'Arial', sans-serif;">High5 Daycare</h1>
        </div>
        <p style="font-family: 'Arial', sans-serif;"><b>Dear Admin,</b></p>
        <p style="font-family: 'Arial', sans-serif;">A new contact message has been recieved.</p>
