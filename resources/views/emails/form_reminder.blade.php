...
<body>
    <div class="container">
        ...
        <p style="font-family: 'Arial', sans-serif;"><b>Dear {{ucfirst($parent->name)}},</b></p>
        <p style="font-family: 'Arial', sans-serif;">URGENT: Complete your child's documents now to avoid any disruptions. Your quick response is appreciated!</p>
        <div class="table-container">
            <table class="table">
                ...
                <tr>
                    <td>Kids with Unfilled Forms</td>
                    <td>
                        @if (count($unfilledKids) > 0)
                        <ul>
                            @foreach ($unfilledKids as $kidName)
                            <li>{{ $kidName }}</li>
                            @endforeach
                        </ul>
                        @else
                <p>All forms are filled.</p>
                        @endif
                    </td>
                </tr>
                <tr>
                    <td>Total Unfilled Forms</td>
                    <td>{{ $totalDocumentsCount }}</td>
                </tr>
            </table>
        </div>
        <p style="font-family: 'Arial', sans-serif;"> Your child's forms are waiting! Take a moment to complete them now and avoid any unnecessary hassles, please login to you portal and complete that form:</p>
        <p><a class="button" href="{{ route('parent.kids') }}" target="_blank">Login to your Portal</a></p>
